...
//@interface WidgetDemoObject : NSObject
//@end

@interface WidgetDemoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[WidgetDemoObject class]])
		{
			for (NSString *key in [[(WidgetDemoObject*)o modules] allKeys])
			{
