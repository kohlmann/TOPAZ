...
/**
 Base class for all WidgetDemo views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the WidgetDemo view hierarchy (such as wrapped iOS UIViews) was touched.
