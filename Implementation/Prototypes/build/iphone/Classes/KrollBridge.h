...
@interface WidgetDemoObject : KrollCoverageObject {
#else
@interface WidgetDemoObject : KrollObject {
#endif
@private
...
extern NSString * WidgetDemo$ModuleRequireFormat;
