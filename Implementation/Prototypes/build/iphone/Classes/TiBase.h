...
// in simulator we redefine to format for WidgetDemo Developer console
...
{\
	NSString * exceptionName = [@"org.widgetdemo." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.widgetdemo";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWidgetDemoNativeItemNone = -1, 
	UIWidgetDemoNativeItemSpinner = -2,
	UIWidgetDemoNativeItemProgressBar = -3,
	
	UIWidgetDemoNativeItemSlider = -4,
	UIWidgetDemoNativeItemSwitch = -5,
	UIWidgetDemoNativeItemMultiButton = -6,
	UIWidgetDemoNativeItemSegmented = -7,
	
	UIWidgetDemoNativeItemTextView = -8,
	UIWidgetDemoNativeItemTextField = -9,
	UIWidgetDemoNativeItemSearchBar = -10,
	
	UIWidgetDemoNativeItemPicker = -11,
	UIWidgetDemoNativeItemDatePicker = -12,
	
	UIWidgetDemoNativeItemInfoLight = -13,
	UIWidgetDemoNativeItemInfoDark = -14,
	
	UIWidgetDemoNativeItemDisclosure = -15,
	
	UIWidgetDemoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all WidgetDemo instances of
